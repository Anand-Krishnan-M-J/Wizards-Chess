...
export interface PieceReduxState {
  ...
  currentMoveIsOf: pieceTypeColor;
}
...
export type MovePieceSiceType = Slice<
  PieceReduxState,
  {
    updateState: (state: PieceReduxState, action: PayloadAction<PieceReduxState>) => void;

    selectPiece: (state: PieceReduxState, action: PayloadAction<selectPiecePayload>) => void;

    hoverPiece: (state: PieceReduxState, action: PayloadAction<hoverPiecePayload>) => void;

    movePiece: (state: PieceReduxState, action: PayloadAction<movePiecePayload>) => void;
  }
>;
