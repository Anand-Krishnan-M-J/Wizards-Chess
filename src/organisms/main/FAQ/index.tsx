...
const accordionItems = [
    {
        ...
        answer: "Start by creating a game. Enter your name and receive a unique game code by clicking the 'Generate new game code' button. Share this code with your opponent, who, by entering their name and the provided code, seamlessly joins the game. Wizards Chess provides an interactive multiplayer environment, allowing players to communicate through built-in audio and video features, enhancing the overall gaming immersion."
    },
    {
        question: "Is Wizards Chess suitable for children?",
        answer: "Absolutely! Wizards Chess is designed without violence, making it family-friendly. It's an ideal platform for children to learn chess. Additionally, kids can share the game with mentors, even those far away, and leverage video and audio capabilities for interactive communication during gameplay."
    },
    {
        question: "Can I play Wizards Chess on my mobile device?",
        answer: "Wizards Chess is a 3D multiplayer game, and while the pages are mobile friendly, playing in 3D mode on a mobile phone might be challenging due to the small screen size. However, a user-friendly 2D version is currently in development. Soon, mobile users will have the option to enjoy the game in 2D mode for an optimized experience on their phones."
    },
    {
