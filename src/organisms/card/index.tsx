...
export const ImageCard = ({ src, name, description, isSelected }: ImageCardProps) => {
    return <div className={styles.image__card__container}>
        <div className={styles.image__card__content}>
            <Image
                width={200}
                src={src}
                alt={name}
                className={styles.image__card__image}
                 />
            <div className={styles.image__card__overlay}>
                <h3 className={styles.image__card__name}>{name}</h3>
                <p className={styles.image__card__description}>
                    {description}
                </p>
            </div>
            <Image
                ...
                src={src}
                alt={name}
                className={styles["image__card__image--mobile"]}
                 />
